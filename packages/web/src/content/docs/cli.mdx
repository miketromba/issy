...
```bash
issy learn              # Compact default guidance
issy learn topics       # List focused topics
issy learn authoring    # Issue writing guidance
issy learn roadmap      # Roadmap placement rules
issy learn commands     # CLI command reference for agents
issy learn hooks        # Hook file behavior
issy learn agents       # AGENTS.md and skill bootstrap guidance
